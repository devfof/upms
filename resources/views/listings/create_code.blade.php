<x-layout>
  <x-card class="p-10 max-w-xl mx-auto mt-24">
    <header class="text-center">
      <h2 class="text-2xl font-bold uppercase mb-1">Create Code</h2>
    </header>
    ...
    <form method="POST" action="/listings" enctype="multipart/form-data">
      ...
      <div class="mb-6">
        ...
        <textarea class="border border-gray-200 rounded p-2 w-full" name="code" rows="20"
          placeholder="Write something cool about your project.">{{old('code')}}</textarea>
